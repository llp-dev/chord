*[bytemuck](../index.md) / [anybitpattern](index.md)*

---

# Module `anybitpattern`
...
The requirements for this is very similar to [`Pod`](../index.md), except that the type
...
*immutable* references and *owned* values into [`AnyBitPattern`](../index.md) types, not
*mutable* references.

[`Pod`](../index.md) is a subset of [`AnyBitPattern`](../index.md), meaning that any `T: Pod` is also
[`AnyBitPattern`](../index.md) but any `T: AnyBitPattern` is not necessarily [`Pod`](../index.md).

[`AnyBitPattern`](../index.md) is a subset of [`Zeroable`](../index.md), meaning that any `T:
AnyBitPattern` is also [`Zeroable`](../index.md), but any `T: Zeroable` is not
necessarily [`AnyBitPattern`](../index.md)
...
Similar to [`Pod`](../index.md) except we disregard the rule about it must not contain
