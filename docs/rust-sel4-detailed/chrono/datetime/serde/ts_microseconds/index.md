*[chrono](../../../index.md) / [datetime](../../index.md) / [serde](../index.md) / [ts_microseconds](index.md)*
...
|------|------|-------------|
| [`serialize`](#serialize) | fn | Serialize a UTC datetime into an integer number of microseconds since the epoch |
| [`deserialize`](#deserialize) | fn | Deserialize a `DateTime` from a microsecond timestamp |
