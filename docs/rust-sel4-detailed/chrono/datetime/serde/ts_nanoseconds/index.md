*[chrono](../../../index.md) / [datetime](../../index.md) / [serde](../index.md) / [ts_nanoseconds](index.md)*
...
|------|------|-------------|
| [`serialize`](#serialize) | fn | Serialize a UTC datetime into an integer number of nanoseconds since the epoch |
| [`deserialize`](#deserialize) | fn | Deserialize a [`DateTime`] from a nanosecond timestamp |
...
Deserialize a [`DateTime`](../../index.md) from a nanosecond timestamp
