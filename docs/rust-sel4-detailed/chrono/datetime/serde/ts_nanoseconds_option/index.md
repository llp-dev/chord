*[chrono](../../../index.md) / [datetime](../../index.md) / [serde](../index.md) / [ts_nanoseconds_option](index.md)*
...
| [`serialize`](#serialize) | fn | Serialize a UTC datetime into an integer number of nanoseconds since the epoch or none |
| [`deserialize`](#deserialize) | fn | Deserialize a `DateTime` from a nanosecond timestamp or none |
...
- <span id="optionnanosecondstimestampvisitor-visitor-type-value"></span>`type Value = Option<DateTime<Utc>>`
