*[chrono](../../../../index.md) / [naive](../../../index.md) / [datetime](../../index.md) / [serde](../index.md) / [ts_milliseconds_option](index.md)*
...
| [`serialize`](#serialize) | fn | Serialize a datetime into an integer number of milliseconds since the epoch or none |
| [`deserialize`](#deserialize) | fn | Deserialize a `NaiveDateTime` from a millisecond timestamp or none |
...
- <span id="optionmillisecondstimestampvisitor-visitor-type-value"></span>`type Value = Option<NaiveDateTime>`
