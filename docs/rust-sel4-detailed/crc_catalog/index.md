...
|------|------|-------------|
| [`algorithm`](#algorithm) | mod | CRC algorithms as structs. |
| [`poly`](#poly) | mod | CRC polynomials and their aliases. |
| [`Algorithm`](#algorithm) | struct | This struct describes a CRC algorithm using the fields specified by the [Catalogue of parametrised CRC algorithms](https://reveng.sourceforge.io/crc-catalogue/all.htm). |
| [`Width`](#width) | trait |  |
...
- [`algorithm`](algorithm/index.md) — CRC algorithms as structs.
- [`poly`](poly/index.md) — CRC polynomials and their aliases.
