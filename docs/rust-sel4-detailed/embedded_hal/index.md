...
|------|------|-------------|
| [`delay`](#delay) | mod | Delays. |
| [`digital`](#digital) | mod | Digital I/O. |
| [`i2c`](#i2c) | mod | Blocking I2C API. |
| [`pwm`](#pwm) | mod | Pulse Width Modulation (PWM) traits. |
| [`spi`](#spi) | mod | Blocking SPI master mode traits. |
| [`private`](#private) | mod |  |

## Modules

- [`delay`](delay/index.md) — Delays.
- [`digital`](digital/index.md) — Digital I/O.
- [`i2c`](i2c/index.md) — Blocking I2C API.
- [`pwm`](pwm/index.md) — Pulse Width Modulation (PWM) traits.
- [`spi`](spi/index.md) — Blocking SPI master mode traits.
