...
- [Modules](#modules)
  - [`fse_decoder`](#fse-decoder)
  - [`fse_encoder`](#fse-encoder)
- [Structs](#structs)
...
|------|------|-------------|
| [`fse_decoder`](#fse-decoder) | mod |  |
| [`fse_encoder`](#fse-encoder) | mod |  |
...
- [`fse_decoder`](fse_decoder/index.md)
- [`fse_encoder`](fse_encoder/index.md)
...
- <span id="fsedecoder-new"></span>`fn new(table: &'t FSETable) -> FSEDecoder<'t>` — [`FSETable`](#fsetable), [`FSEDecoder`](#fsedecoder)
...
- <span id="fsetable-new"></span>`fn new(max_symbol: u8) -> FSETable` — [`FSETable`](#fsetable)
