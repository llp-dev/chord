*[ruzstd](../../index.md) / [huff0](../index.md) / [huff0_decoder](index.md)*

---

# Module `huff0_decoder`
...
- <span id="huffmandecoder-new"></span>`fn new(table: &'t HuffmanTable) -> HuffmanDecoder<'t>` — [`HuffmanTable`](../index.md#huffmantable), [`HuffmanDecoder`](../index.md#huffmandecoder)
...
- <span id="huffmantable-new"></span>`fn new() -> HuffmanTable` — [`HuffmanTable`](../index.md#huffmantable)
