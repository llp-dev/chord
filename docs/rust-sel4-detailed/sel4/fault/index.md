...
- <span id="nullfault-clone"></span>`fn clone(&self) -> NullFault` — [`NullFault`](#nullfault)
...
- <span id="nullfault-partialeq-eq"></span>`fn eq(&self, other: &NullFault) -> bool` — [`NullFault`](#nullfault)
...
- <span id="capfault-clone"></span>`fn clone(&self) -> CapFault` — [`CapFault`](#capfault)
...
- <span id="capfault-partialeq-eq"></span>`fn eq(&self, other: &CapFault) -> bool` — [`CapFault`](#capfault)
...
- <span id="unknownsyscall-clone"></span>`fn clone(&self) -> UnknownSyscall` — [`UnknownSyscall`](#unknownsyscall)
...
- <span id="unknownsyscall-partialeq-eq"></span>`fn eq(&self, other: &UnknownSyscall) -> bool` — [`UnknownSyscall`](#unknownsyscall)
...
- <span id="userexception-clone"></span>`fn clone(&self) -> UserException` — [`UserException`](#userexception)
...
- <span id="userexception-partialeq-eq"></span>`fn eq(&self, other: &UserException) -> bool` — [`UserException`](#userexception)
...
- <span id="vmfault-clone"></span>`fn clone(&self) -> VmFault` — [`VmFault`](#vmfault)
...
- <span id="vmfault-partialeq-eq"></span>`fn eq(&self, other: &VmFault) -> bool` — [`VmFault`](#vmfault)
...
- <span id="fault-clone"></span>`fn clone(&self) -> Fault` — [`Fault`](#fault)
...
- <span id="fault-partialeq-eq"></span>`fn eq(&self, other: &Fault) -> bool` — [`Fault`](#fault)
