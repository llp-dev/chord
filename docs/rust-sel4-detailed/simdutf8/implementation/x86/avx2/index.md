*[simdutf8](../../../index.md) / [implementation](../../index.md) / [x86](../index.md) / [avx2](index.md)*
...
```rust
struct SimdInput {
    vals: [crate::implementation::helpers::SimdU8Value<core::arch::x86_64::__m256i>; 2],
}
```
...
```rust
type SimdU8Value = crate::implementation::helpers::SimdU8Value<core::arch::x86_64::__m256i>;
```
