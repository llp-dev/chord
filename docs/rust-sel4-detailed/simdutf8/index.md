...
Use [`basic::from_utf8()`](basic/index.md) as a drop-in replacement for `std::str::from_utf8()`.
...
If you need detailed information on validation failures, use [`compat::from_utf8()`](compat/index.md)
instead.
...
is not valid UTF-8. [`basic::Utf8Error`](basic/index.md) is a zero-sized error struct.

### Compat flavor
The `compat` flavor is fully API-compatible with `std::str::from_utf8()`. In particular, [`compat::from_utf8()`](compat/index.md)
returns a [`compat::Utf8Error`](compat/index.md), which has [`valid_up_to()`](compat::Utf8Error#method.valid_up_to) and
...
This comes at a slight performance penalty compared to the [`basic`](basic/index.md) API even if the input is valid UTF-8.
...
|------|------|-------------|
| [`basic`](#basic) | mod | The `basic` API flavor provides barebones UTF-8 checking at the highest speed. |
| [`compat`](#compat) | mod | The `compat` API flavor provides full compatibility with [`std::str::from_utf8()`] and detailed validation errors. |
| [`implementation`](#implementation) | mod | Contains UTF-8 validation implementations. |

## Modules

- [`basic`](basic/index.md) — The `basic` API flavor provides barebones UTF-8 checking at the highest speed.
- [`compat`](compat/index.md) — The `compat` API flavor provides full compatibility with [`std::str::from_utf8()`] and detailed validation errors.
- [`implementation`](implementation/index.md) — Contains UTF-8 validation implementations.
