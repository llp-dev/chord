*[zerocopy](../../index.md) / [ref](../index.md) / [def](index.md)*
...
|------|------|-------------|
| [`Ref`](#ref) | struct | A typed reference derived from a byte slice. |
...
- <span id="ref-new-unchecked"></span>`unsafe fn new_unchecked(bytes: B) -> Ref<B, T>` — [`Ref`](#ref)
...
- <span id="ref-clone"></span>`fn clone(&self) -> Ref<B, T>` — [`Ref`](#ref)
