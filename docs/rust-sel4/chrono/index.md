...
*1 struct, 1 type alias, 6 modules*

### [`date`](date.md)

*1 struct, 2 constants*

### [`datetime`](datetime.md)

*1 struct, 2 constants*

### [`datetime::serde`](datetime/serde.md)

*8 modules*

### [`datetime::serde::ts_microseconds`](datetime/serde/ts_microseconds.md)

*2 functions*

### [`datetime::serde::ts_microseconds_option`](datetime/serde/ts_microseconds_option.md)

*2 functions*

### [`datetime::serde::ts_milliseconds`](datetime/serde/ts_milliseconds.md)

*2 functions*

### [`datetime::serde::ts_milliseconds_option`](datetime/serde/ts_milliseconds_option.md)

*2 functions*

### [`datetime::serde::ts_nanoseconds`](datetime/serde/ts_nanoseconds.md)

*2 functions*

### [`datetime::serde::ts_nanoseconds_option`](datetime/serde/ts_nanoseconds_option.md)

*2 functions*

### [`datetime::serde::ts_seconds`](datetime/serde/ts_seconds.md)

*2 functions*

### [`datetime::serde::ts_seconds_option`](datetime/serde/ts_seconds_option.md)

*2 functions*

### [`format`](format.md)

*1 module, 1 type alias, 4 structs, 7 enums*

### [`format::formatting`](format/formatting.md)

*1 enum*

### [`format::parse`](format/parse.md)

*2 functions*

### [`format::parsed`](format/parsed.md)

*1 struct*

### [`format::strftime`](format/strftime.md)
...
### [`naive::date`](naive/date.md)

*2 constants, 3 structs*

### [`naive::datetime`](naive/datetime.md)

*1 struct, 2 constants*

### [`naive::datetime::serde`](naive/datetime/serde.md)

*8 modules*

### [`naive::datetime::serde::ts_microseconds`](naive/datetime/serde/ts_microseconds.md)

*2 functions*

### [`naive::datetime::serde::ts_microseconds_option`](naive/datetime/serde/ts_microseconds_option.md)

*2 functions*

### [`naive::datetime::serde::ts_milliseconds`](naive/datetime/serde/ts_milliseconds.md)

*2 functions*

### [`naive::datetime::serde::ts_milliseconds_option`](naive/datetime/serde/ts_milliseconds_option.md)

*2 functions*

### [`naive::datetime::serde::ts_nanoseconds`](naive/datetime/serde/ts_nanoseconds.md)

*2 functions*

### [`naive::datetime::serde::ts_nanoseconds_option`](naive/datetime/serde/ts_nanoseconds_option.md)

*2 functions*

### [`naive::datetime::serde::ts_seconds`](naive/datetime/serde/ts_seconds.md)

*2 functions*

### [`naive::datetime::serde::ts_seconds_option`](naive/datetime/serde/ts_seconds_option.md)

*2 functions*

### [`naive::isoweek`](naive/isoweek.md)

*1 struct*

### [`naive::time`](naive/time.md)

*1 struct*

### [`offset`](offset.md)

*1 enum, 1 type alias, 2 traits*

### [`offset::fixed`](offset/fixed.md)

*1 struct*

### [`offset::utc`](offset/utc.md)
