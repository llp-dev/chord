**chrono > naive > datetime > serde > ts_microseconds**

# Module: naive::datetime::serde::ts_microseconds

## Contents

**Functions**

- [`deserialize`](#deserialize) - Deserialize a `NaiveDateTime` from a microseconds timestamp
- [`serialize`](#serialize) - Serialize a datetime into an integer number of microseconds since the epoch

---

## chrono::naive::datetime::serde::ts_microseconds::deserialize
...
## chrono::naive::datetime::serde::ts_microseconds::serialize
