...
- [`FixedState`](#fixedstate) - A [`BuildHasher`] for [`quality::FoldHasher`](FoldHasher) that always has the same fixed seed.
- [`FoldHasher`](#foldhasher) - A [`Hasher`] instance implementing foldhash, optimized for quality.
- [`RandomState`](#randomstate) - A [`BuildHasher`] for [`quality::FoldHasher`](FoldHasher) that is randomly initialized.
- [`SeedableRandomState`](#seedablerandomstate) - A [`BuildHasher`] for [`quality::FoldHasher`](FoldHasher) that is randomly
