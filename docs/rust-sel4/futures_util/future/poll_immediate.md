**futures_util > future > poll_immediate**

# Module: future::poll_immediate

## Contents

**Structs**

- [`PollImmediate`](#pollimmediate) - Future for the [`poll_immediate`](poll_immediate()) function.

**Functions**

- [`poll_immediate`](#poll_immediate) - Creates a future that is immediately ready with an Option of a value.

---

## futures_util::future::poll_immediate::PollImmediate
...
- **Clone**
  - `fn clone(self: &Self) -> PollImmediate<T>`



## futures_util::future::poll_immediate::poll_immediate
...
```rust
fn poll_immediate<F>(f: F) -> PollImmediate<F>
```
