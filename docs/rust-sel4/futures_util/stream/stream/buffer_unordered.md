**futures_util > stream > stream > buffer_unordered**

# Module: stream::stream::buffer_unordered

## Contents

**Structs**

- [`BufferUnordered`](#bufferunordered) - Stream for the [`buffer_unordered`](super::StreamExt::buffer_unordered)

---

## futures_util::stream::stream::buffer_unordered::BufferUnordered
