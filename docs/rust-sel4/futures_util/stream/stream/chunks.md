**futures_util > stream > stream > chunks**

# Module: stream::stream::chunks

## Contents

**Structs**

- [`Chunks`](#chunks) - Stream for the [`chunks`](super::StreamExt::chunks) method.

---

## futures_util::stream::stream::chunks::Chunks
