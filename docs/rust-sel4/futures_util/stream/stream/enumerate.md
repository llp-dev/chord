**futures_util > stream > stream > enumerate**

# Module: stream::stream::enumerate

## Contents

**Structs**

- [`Enumerate`](#enumerate) - Stream for the [`enumerate`](super::StreamExt::enumerate) method.

---

## futures_util::stream::stream::enumerate::Enumerate
