**futures_util > stream > stream > filter**

# Module: stream::stream::filter

## Contents

**Structs**

- [`Filter`](#filter) - Stream for the [`filter`](super::StreamExt::filter) method.

---

## futures_util::stream::stream::filter::Filter
