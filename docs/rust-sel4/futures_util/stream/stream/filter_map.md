**futures_util > stream > stream > filter_map**

# Module: stream::stream::filter_map

## Contents

**Structs**

- [`FilterMap`](#filtermap) - Stream for the [`filter_map`](super::StreamExt::filter_map) method.

---

## futures_util::stream::stream::filter_map::FilterMap
