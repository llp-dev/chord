**futures_util > stream > stream > fuse**

# Module: stream::stream::fuse

## Contents

**Structs**

- [`Fuse`](#fuse) - Stream for the [`fuse`](super::StreamExt::fuse) method.

---

## futures_util::stream::stream::fuse::Fuse
...
- `fn is_done(self: &Self) -> bool` - Returns whether the underlying stream has finished or not.
