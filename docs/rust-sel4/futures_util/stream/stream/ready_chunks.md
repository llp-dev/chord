**futures_util > stream > stream > ready_chunks**

# Module: stream::stream::ready_chunks

## Contents

**Structs**

- [`ReadyChunks`](#readychunks) - Stream for the [`ready_chunks`](super::StreamExt::ready_chunks) method.

---

## futures_util::stream::stream::ready_chunks::ReadyChunks
