**futures_util > stream > stream > skip_while**

# Module: stream::stream::skip_while

## Contents

**Structs**

- [`SkipWhile`](#skipwhile) - Stream for the [`skip_while`](super::StreamExt::skip_while) method.

---

## futures_util::stream::stream::skip_while::SkipWhile
