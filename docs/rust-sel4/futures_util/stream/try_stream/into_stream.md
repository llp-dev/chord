**futures_util > stream > try_stream > into_stream**

# Module: stream::try_stream::into_stream

## Contents

**Structs**

- [`IntoStream`](#intostream) - Stream for the [`into_stream`](super::TryStreamExt::into_stream) method.

---

## futures_util::stream::try_stream::into_stream::IntoStream
