**futures_util > stream > try_stream > try_filter**

# Module: stream::try_stream::try_filter

## Contents

**Structs**

- [`TryFilter`](#tryfilter) - Stream for the [`try_filter`](super::TryStreamExt::try_filter)

---

## futures_util::stream::try_stream::try_filter::TryFilter
