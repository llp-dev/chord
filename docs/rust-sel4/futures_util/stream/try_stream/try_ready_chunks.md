**futures_util > stream > try_stream > try_ready_chunks**

# Module: stream::try_stream::try_ready_chunks

## Contents

**Structs**

- [`TryReadyChunks`](#tryreadychunks) - Stream for the [`try_ready_chunks`](super::TryStreamExt::try_ready_chunks) method.
- [`TryReadyChunksError`](#tryreadychunkserror) - Error indicating, that while chunk was collected inner stream produced an error.

---

## futures_util::stream::try_stream::try_ready_chunks::TryReadyChunks
...
## futures_util::stream::try_stream::try_ready_chunks::TryReadyChunksError
...
- **PartialEq**
  - `fn eq(self: &Self, other: &TryReadyChunksError<T, E>) -> bool`
- **Debug**
  - `fn fmt(self: &Self, f: & mut fmt::Formatter) -> fmt::Result`
