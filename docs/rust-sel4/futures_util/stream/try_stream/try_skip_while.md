**futures_util > stream > try_stream > try_skip_while**

# Module: stream::try_stream::try_skip_while

## Contents

**Structs**

- [`TrySkipWhile`](#tryskipwhile) - Stream for the [`try_skip_while`](super::TryStreamExt::try_skip_while)

---

## futures_util::stream::try_stream::try_skip_while::TrySkipWhile
