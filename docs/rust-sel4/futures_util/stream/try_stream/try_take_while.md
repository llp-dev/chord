**futures_util > stream > try_stream > try_take_while**

# Module: stream::try_stream::try_take_while

## Contents

**Structs**

- [`TryTakeWhile`](#trytakewhile) - Stream for the [`try_take_while`](super::TryStreamExt::try_take_while)

---

## futures_util::stream::try_stream::try_take_while::TryTakeWhile
