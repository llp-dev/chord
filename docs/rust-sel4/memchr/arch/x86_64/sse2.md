...
# Module: arch::x86_64::sse2

## Contents

**Modules**

- [`memchr`](#memchr) - This module defines 128-bit vector implementations of `memchr` and friends.
- [`packedpair`](#packedpair) - A 128-bit vector implementation of the "packed pair" SIMD algorithm.
