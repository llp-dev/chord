...
# Module: arch::x86_64::sse2::packedpair

## Contents

**Structs**

- [`Finder`](#finder) - A "packed pair" finder that uses 128-bit vector operations.

---

## memchr::arch::x86_64::sse2::packedpair::Finder
...
- `fn find(self: &Self, haystack: &[u8], needle: &[u8]) -> Option<usize>` - Execute a search using SSE2 vectors and routines.
