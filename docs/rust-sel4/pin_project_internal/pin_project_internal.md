...
# Module: pin_project_internal

## Contents

**Proc Macros**

- [`pin_project`](#pin_project) - An attribute that creates projection types covering all the fields of
- [`pinned_drop`](#pinned_drop) - An attribute used for custom implementations of [`Drop`].
...
## pin_project_internal::pinned_drop
