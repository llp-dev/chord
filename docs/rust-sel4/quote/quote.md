...
- [`format_ident`](#format_ident) - Formatting macro for constructing `Ident`s.
- [`quote`](#quote) - The whole point.
- [`quote_spanned`](#quote_spanned) - Same as `quote!`, but applies a given span to all tokens originating within
